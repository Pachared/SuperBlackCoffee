...
type ReceiptTextIconProps = HTMLAttributes<HTMLDivElement> & {
  animate?: boolean;
  size?: number;
};
...
export const ReceiptTextIcon = forwardRef<
  ReceiptTextIconHandle,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.path d="M8 8H14" variants={lineVariants} />
          <motion.path d="M8 12H16" variants={lineVariants} />
          <motion.path d="M8 16H13" variants={lineVariants} />
        </motion.g>
      </motion.svg>
    </div>
  );
